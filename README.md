...
## 14. Project 3 Checklist

- [x] Project is prepared as Project 3
- [x] Factory Pattern with BookFactory
- [x] Strategy Pattern with DiscountStrategy
- [x] Template class Repository<T>
- [x] Template function printCollection<T>
- [x] File input from data/books.csv
- [x] README self-review
- [x] Bibliography/resources
- [ ] Code review #3 for 2 projects
- [ ] Git tag v0.3
